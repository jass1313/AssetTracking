...
//  Go BambooRose
//
//  Created by Satyanarayana on 20/12/16.
//  Copyright © 2016 Bamboorose. All rights reserved.
//
...
extension UIColor {
    ...
    public convenience init(rgba_throws rgba: String) throws {
        ...
        let strtIndex = rgba.index(rgba.startIndex, offsetBy: 1)
        let hexString: String =  String(rgba[strtIndex...])
